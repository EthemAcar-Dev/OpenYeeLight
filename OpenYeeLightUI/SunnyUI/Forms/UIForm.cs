...
namespace Sunny.UI
{
    public partial class UIForm : Form, IStyleInterface
    {
        ...
        protected override void OnSizeChanged(EventArgs e)
        {
            ...
            else if (base.WindowState == FormWindowState.Normal && Opacity == 0 && _tmrFadeIn.Enabled == false)
            {
                _tmrFadeIn = new Timer
                {
                    Interval = 1,
                    Enabled = true,
                };
                _tmrFadeIn.Tick += FadeIn_Tick;
            }
        }
